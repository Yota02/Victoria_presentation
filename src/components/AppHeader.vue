  ...
  <header class="bg-white/80 backdrop-blur-sm sticky top-0 z-50 border-b border-gray-200">
    <nav class="container mx-auto px-6 py-4 flex justify-between items-center">
      ...
      <div class="hidden md:flex space-x-6 items-center">
        ...
        <router-link to="/#modules" class="text-gray-600 hover:text-victori-cyan transition duration-300">Modules</router-link>
        <router-link to="/#privacy" class="text-gray-600 hover:text-victori-cyan transition duration-300">Confidentialité</router-link>
